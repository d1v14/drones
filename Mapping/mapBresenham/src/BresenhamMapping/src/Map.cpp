...
void Map::Bresenham(std::vector<int> values,int value){
  int x2 = values[0];
  int y2 = values[1];
  int z2 = values[2];
  ...
  if (dx >= dy && dx >= dz) {
    ...
    this->grid[x2][y2][z2] = value;
}


void Map::setValueToMap(double x, double y, double z, int value){ 
